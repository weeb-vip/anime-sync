...
type Anime struct {
	...
	StartDate     sql.NullTime `gorm:"column:start_date;type:timestamp;null" json:"start_date"`
	EndDate       sql.NullTime `gorm:"column:end_date;type:timestamp;null" json:"end_date"`
